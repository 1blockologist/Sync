    ...
    rpcConsole(0)
{
  //  resize(1000, 520
    ...
    setWindowTitle(tr("Sync") + " - " + tr("Wallet"));


    qApp->setStyleSheet("QMainWindow { background:rgb(237,241,247);font-family:'Proxima Nova Rg'; }"

                           "#toolbar2 { border:none;width:28px;background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(35,35,35), stop: 1 rgb(0,141,210)) }"
                            "QMenu { background: rgb(35,35,35); color:white; padding-bottom:10px; } "
                            "QMenu::item { color:white; background-color: transparent; } "
                            "QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(35,35,35), stop: 1 rgb(0, 141, 210)); }"
   ...
   // createToolBars();
    ...
    statusBar()->setStyleSheet(  "QStatusBar{      background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(35,35,35), stop: 1 rgb(0,141,210));               }"    );
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Sync address"));
    ...
    blockAction = new QAction(QIcon(":/icons/bex"), tr("&Block Explorer"), this);
          ...
          statisticsAction = new QAction(QIcon(":/icons/node"), tr("&Nodes Control"), this);
                  ...
                  chatAction = new QAction(QIcon(":/icons/social"), tr("&Social Networks "), this);
                           ...
                           sendCoinsAction2 = new QAction(QIcon(":/icons/send1"), tr("&Send coins"), this);
                           sendCoinsAction2->setToolTip(tr("Send coins to a Sync address"));
                           sendCoinsAction2->setCheckable(true);
                           sendCoinsAction2->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));

                               receiveCoinsAction2 = new QAction(QIcon(":/icons/receive1"), tr("&Receive coins"), this);
                           receiveCoinsAction2->setToolTip(tr("Show the list of addresses for receiving payments"));
                           receiveCoinsAction2->setCheckable(true);
                           receiveCoinsAction2->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    ...
    connect(sendCoinsAction2, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(sendCoinsAction2, SIGNAL(triggered()), this, SLOT(gotoSendCoinsPage()));

    connect(receiveCoinsAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(receiveCoinsAction, SIGNAL(triggered()), this, SLOT(gotoReceiveCoinsPage()));


    connect(receiveCoinsAction2, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(receiveCoinsAction2, SIGNAL(triggered()), this, SLOT(gotoReceiveCoinsPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Sync"), this);
    aboutAction->setToolTip(tr("Show information about Sync"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Sync"));
    optionsAction->setMenuRole(QAction::PreferencesRole);


    optionsAction2 = new QAction(QIcon(":/icons/configure2"), tr("&Options..."), this);
    optionsAction2->setToolTip(tr("Modify configuration options for Sync"));
    optionsAction2->setMenuRole(QAction::PreferencesRole);


    exportAction2 = new QAction(QIcon(":/icons/export2"), tr("&Export..."), this);
    exportAction2->setToolTip(tr("Export the data in the current tab to a file"));
    ...
    connect(optionsAction, SIGNAL(triggered()), this, SLOT(optionsClicked()));
     connect(optionsAction2, SIGNAL(triggered()), this, SLOT(optionsClicked()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    settings->addAction(optionsAction2);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Sync client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Sync client"));
    ...
    trayIconMenu->addAction(sendCoinsAction2);
    trayIconMenu->addAction(receiveCoinsAction2);
    trayIconMenu->addSeparator();
    trayIconMenu->addAction(signMessageAction);
    trayIconMenu->addAction(verifyMessageAction);
    trayIconMenu->addSeparator();
    trayIconMenu->addAction(optionsAction2);
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sync network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Sync address or malformed URI parameters."));
    }
